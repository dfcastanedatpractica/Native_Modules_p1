...
import{AppRegistry ,Platform, StyleSheet, Text, View, NativeModules, TextInput, Switch} from 'react-native';
  ...
  render() {
    return (
      <View>
        ...
        <Text>Admin</Text>
        <Switch onValueChange={(value) => this.setState({isAdmin: value})} value={this.state.isAdmin}/>
        <Button
